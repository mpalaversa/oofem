...
public:
    ...
    FloatArrayF<6> giveRealStress_Shell(const FloatArrayF<3>& membraneStrains, const FloatArrayF<3>& plateStrains, GaussPoint* gp, TimeStep* tStep) const override;
    ...
    FloatArrayF<6> giveGeneralizedStress_EBBeam(const FloatArrayF<4>& generalizedStrain, GaussPoint* gp, TimeStep* tStep) const override;
    ...
    FloatMatrixF<4, 4> giveEBBeamStiffMtrx(MatResponseMode mode, GaussPoint* gp, TimeStep* tStep) const override;
    FloatMatrixF<5,5> give2dPlateStiffMtrx(MatResponseMode mode, GaussPoint *gp, TimeStep *tStep) const override;
    FloatMatrixF<3, 3> giveKirchhoffPlateStiffMtrx(MatResponseMode mode, GaussPoint* gp, TimeStep* tStep) const override;
