...
public:
    ...
    FloatArrayF<3> giveRealStress_KirchhoffPlate(const FloatArrayF<3>& reducedStrain, GaussPoint* gp, TimeStep* tStep, double z) const override { OOFEM_ERROR("Not implemented for fibered cross section."); }
