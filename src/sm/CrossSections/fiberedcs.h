...
public:
    ...
    FloatArrayF<2> giveRealStress_Netting( const FloatArrayF<2> &reducedStrain, GaussPoint *gp, TimeStep *tStep, bool saveContext = true ) const override { OOFEM_ERROR( "Not implemented for fibered cross section." ); }
