...
public:
    ...
    FloatMatrixF<4, 4> giveEBBeamStiffMtrx(MatResponseMode mode, GaussPoint* gp, TimeStep* tStep) const override { OOFEM_ERROR("Not implemented for layered cross section."); }
