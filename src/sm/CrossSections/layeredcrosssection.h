...
public:
    ...
    FloatArrayF<2> giveRealStress_Netting( const FloatArrayF<2> &reducedStrain, GaussPoint *gp, TimeStep *tStep ) const override { OOFEM_ERROR( "Not implemented for layered cross section." ); }
